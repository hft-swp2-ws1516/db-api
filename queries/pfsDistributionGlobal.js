(function () {
    ...
    var startQuery = function() {
        ...
        Scan.aggregate([
            ...
            pfsDistribution.tld = TLD_UNSPECIFIED;

            var plainData = pfsDistribution.toObject();
            delete plainData._id;

            var upsertQuery = { month: pfsDistribution.month, tld: TLD_UNSPECIFIED };
            PfsDistribution.findOneAndUpdate(upsertQuery, plainData, {upsert:true}, function(err, doc){
                if (err) { throw err; }
